...
/*
	Modified FacebookController by Terumi : https://github.com/Terumi
	original source : https://github.com/Terumi/AngularJS-Facebook-Login
 */

angular.module('CrudApp')
  .controller('FacebookCtrl', function ($scope, $rootScope, Facebook) {    
    ...
    $rootScope.$on("fb_connected", function (event, args) {
        /*
         ...
         facebook, his facebook_id will be enough to authenticate him in our app,
    ...
    $scope.getInfo = function () {
        ...
        FB.api('/' + $rootScope.session, function (response) {
            console.log('Good to see you, ' + response + '.');
      			console.log(response);
      			console.log($rootScope.session.facebook_id);
        });
